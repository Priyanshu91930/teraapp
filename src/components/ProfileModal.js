              ...
              >
                ...
                <View style={styles.rowTextCol}>
                  ...
                  <Text style={styles.rowSubtitle}>
                    {isPremium ? 'View active plan, expiry & 6 unlocked features' : 'Tap to view membership benefits'}
                  </Text>
                </View>
                <Ionicons name="chevron-forward" size={18} color="#A1A1AA" />
              </TouchableOpacity>
                ...
                <LinearGradient colors={['#1E293B', '#0F172A']} style={styles.manageStatusCard}>
                  <View style={styles.manageStatusBadge}>
                    ...
                    <Text style={styles.manageStatusBadgeText}>
                      {isPremium ? '★ VIP MEMBERSHIP ACTIVE' : 'FREE USER'}
                    </Text>
                  </View>
                  <Text style={styles.managePlanName}>
                    {isPremium ? `${user.plan ? user.plan.toUpperCase() : 'YEARLY'} VIP PLAN` : 'No Active Plan'}
                  </Text>
